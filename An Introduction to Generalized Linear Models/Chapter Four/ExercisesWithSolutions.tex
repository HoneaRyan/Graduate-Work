...
\NormalTok{for (i in }\DecValTok{1}\NormalTok{:}\DecValTok{1000}\NormalTok{) \{}
  ...
  \NormalTok{W =}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(w_ii) %*%}\StringTok{ }\KeywordTok{t}\NormalTok{(}\KeywordTok{sqrt}\NormalTok{(w_ii)) *}\StringTok{ }\KeywordTok{diag}\NormalTok{(}\KeywordTok{length}\NormalTok{(x[,}\DecValTok{1}\NormalTok{]))}
  ...
  \NormalTok{b =}\StringTok{ }\KeywordTok{ginv}\NormalTok{(}\KeywordTok{t}\NormalTok{(x) %*%}\StringTok{ }\NormalTok{W %*%}\StringTok{ }\NormalTok{x) %*%}\StringTok{ }\NormalTok{(}\KeywordTok{t}\NormalTok{(x) %*%}\StringTok{ }\NormalTok{W %*%}\StringTok{ }\NormalTok{z)}
