...
*Solutions: * The canonical form of the Poisson distribution is the following:
...
*Solutions: * The canonical form of the Binomial distribution is 
$$
...
*Solutions: * The canonical form of the binomial distribution is listed in Exercise Three.
...
**(b)**: If $X$ has the Uniford Distribution U$[0,1]$ that is, $f(x) = 1$ for $0 < x < 1$, show that $Y = -\theta \log X$ has the distribution Exp$(\theta)$.
